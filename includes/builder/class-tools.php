...
class Tools {
    ...
    public function admin_scripts( $hook_suffix ) {
        ...
        if ( post_type_supports( $post_type, 'editor' ) && post_type_supports( $post_type, 'fx_builder' ) ) {
            ...
            /* Serialize Object */
            wp_register_script( 'serialize-object', URI . 'assets/library/jquery.serialize-object.min.js', [ 'jquery' ], VERSION, true );

            /* JS */
            wp_enqueue_script( 'fx-builder-tools', URI . 'assets/tools.js', [ 'jquery', 'fx-builder-item', 'serialize-object' ], VERSION, true );
            $ajax_data = [
