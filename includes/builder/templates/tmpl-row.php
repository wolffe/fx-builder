...
<script id="tmpl-fxb-row" type="text/html">
    <div class="fxb-row fxb-clear<# if ( data.row_no_mb == '1' ) { #> fxb-row-no-mb<# } #>" data-id="{{data.id}}" data-index="{{data.index}}"  data-state="{{data.state}}" data-col_num="{{data.col_num}}" data-layout="{{data.layout}}" style="<# if ( data.row_bg_color ) { #>--fxb-row-bg-color: {{data.row_bg_color}};<# } #><# if ( data.row_col_padding ) { #>--fxb-row-col-padding: {{data.row_col_padding}}{{data.row_col_padding_unit}};<# } #>">
