...
- **Plugin type:** ClassicPress/WordPress plugin (page builder). Declared minimum: **PHP 7.4**, **ClassicPress 2.0** (`Requires CP` / readme). No runtime CP version check; testing is typically on current 2.x (e.g. 2.7).
